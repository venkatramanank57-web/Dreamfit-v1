...
// // ============================================
// const CompactStatsCard = ({ icon: Icon, label, value, color }) => (
...
// // ============================================
// const CompactFilterButton = ({ active, onClick, color, label, count }) => (
//   <button
//     onClick={onClick}
...
//     }`}
//   >
//     {label} <span className={`ml-1 px-1 py-0.5 rounded-full text-[10px] ${
//       active ? 'bg-white/20' : 'bg-gray-300/50'
//     }`}>{count}</span>
//   </button>
// );
...
//                   value={searchTerm}
//                   onChange={(e) => setSearchTerm(e.target.value)}
//                   className="pl-9 pr-3 py-1.5 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none w-48 bg-white"
//                 />
//                 {searchTerm && (
//                   <button
//                     onClick={() => setSearchTerm('')}
...
//                 onClick={handleRefresh}
//                 disabled={isLoading}
//                 className="p-1.5 hover:bg-gray-100 rounded-lg transition-all disabled:opacity-50"
//               >
...
//                 <button
//                   onClick={handleMarkAllAsRead}
//                   className="px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all flex items-center gap-1.5 text-xs font-medium shadow-sm"
//                 >
//                   <CheckCheck size={16} />
//                   Mark Read ({unreadCount})
//                 </button>
...
//                 <button
//                   onClick={handleDeleteSelected}
//                   className="px-3 py-1.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all flex items-center gap-1.5 text-xs font-medium shadow-sm"
//                 >
//                   <Trash2 size={16} />
//                   Delete ({selectedNotifications.length})
//                 </button>
...
//             <CompactStatsCard icon={Inbox} label="Total" value={stats.total} color="blue" />
//             <CompactStatsCard icon={Mail} label="Unread" value={stats.unread} color="green" />
//             <CompactStatsCard icon={MailOpen} label="Read" value={stats.read} color="gray" />
//           </div>

//           {/* Filter Tabs - Compact */}
//           <div className="bg-white py-2 mt-1 border-t border-gray-100">
...
//           {/* Select Mode - Compact */}
//           {selectMode && paginatedNotifications.length > 0 && (
//             <div className="bg-gray-50 rounded-lg p-2 mt-1 border border-gray-200">
