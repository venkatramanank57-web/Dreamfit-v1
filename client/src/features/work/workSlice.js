...
const initialState = {
  ...
  recentWorks: [], // ✅ NEW: For dashboard recent works list
...
export const selectDashboardWorkStats = (state) => state.work.dashboardStats;
